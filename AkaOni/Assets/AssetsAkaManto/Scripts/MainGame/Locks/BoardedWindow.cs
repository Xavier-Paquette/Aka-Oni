...
public class BoardedWindow : MonoBehaviour
{
            ...
            if (_colObject.gameObject.tag == "Player")
            {
                ...
                if (Input.GetKey(KeyCode.E))
                {
                    ...
                    if (_colObject.gameObject.GetComponent<Player>().FindItem(_Key))
                    {
                        ...
                        _DialogText.text = "You used the hammer to pull a board out from the window. \n (Wooden Board has been added to your inventory)";
                    ...
                    {
                        _DialogText.text = "This window is boarded up...";
                        textDisplaying = true;
                    }
